...
public class Abdomen extends Ejercicio {
    
    private String zonaMuscular;

    public Abdomen(String zonaMuscular, String nombre, String nivelDificultad, String equipoRequerido, int duracionMinutos) {
        super(nombre, nivelDificultad, equipoRequerido, duracionMinutos);
        this.zonaMuscular = "Abdomen";
    }
